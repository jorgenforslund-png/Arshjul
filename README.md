# Årshjulet – delad Netlify-version 1.8
...
- Sammanhängande flerdagarsaktiviteter har start- och slutdatum, räknas som en aktivitet och visas som vanliga aktivitetskort med datumintervall, antal dagar och ansvarig. En färgmarkering i nederkanten visar periodens faktiska längd. Korten kan dras till ett nytt datum medan periodens längd och eventuella helgdagar behålls.
- En uppdateringslogg i kugghjulsmenyn visar alla versioner med den senaste högst upp. Vid nya releaser läggs en kort sammanfattning först i listan `CHANGELOG`.
